...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [delta_S,h_S,zeta_S,T_sunrise,T_sunset,L_day,E0,jDay,Delta_TSL] = SetSunVariables(Datam,DeltaGMT,Lon,Lat)
%%% INPUT 
%%% Datam %% [Yr, MO, DA, HR]
%%% DeltaGMT [°] 
%%% Lon [°]
...
t_bef= 1;%0.5; %% Integration intervals  usually 1-0 --->  
t_aft= 0;%0.5; %% Integration intervals  
